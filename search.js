// based on https://github.com/hokein/electron-sample-apps/blob/master/webview/browser/browser.js
// <sample code>
...
ipcRenderer.on("trigger", function(evt, trigger) {
    ...
    switch(trigger) {
        ...
        case "startsearch":
            ...
            if(!search) {
                ...
                search = searchInPage(wv);
            }
            search.openSearchWindow();
            break;
    }
});
ipcRenderer.on("loadurl", function(evt, url) {
    navigateTo(url);
});
